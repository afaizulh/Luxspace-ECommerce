                ...
                <div class="slider">
                    <div class="thumbnail">
                        @foreach ($product->gallery as $item)
                            <div class="px-2">
                                <div class="{{ $loop->first ? 'selected' : '' }}" data-img="{{ Storage::url($item->url) }}">
                    ...
                    <div class="px-3 flex-none" style="width: 320px">
                        <div class="rounded-xl p-4 pb-8 relative bg-white">
                            <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                                <img src="{{ $recommendation->gallery()->exists() ? Storage::url($recommendation->gallery->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}" alt=""
