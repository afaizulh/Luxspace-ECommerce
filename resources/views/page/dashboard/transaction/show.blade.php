<x-app-layout>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#"
                                class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-700 dark:hover:text-gray-500">#{{ $transaction->id }}
                                {{ $transaction->name }}</a>
                        </div>
                    </li>
                </ol>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="shadow overflow-hidden sm:rounded-lg bg-white mb-6">
                    ...
                    <table class="table-auto w-full">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border px-6 py-4">{{$transaction->call_number}}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="border px-6 py-4">Rp. {{$transaction->total_price}}</td>
                            </tr>
                            <tr>
