        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($query)
                ->editColumn('action', function ($item) {
                    return '
                    <a href="' . route('dashboard.product.gallery.index', $item->id) . '" class="bg-emerald-500 hover:bg-emerald-700 text-white font-bold mx-2 py-2 px-4 rounded shadow-lg">
                    Gallery
                    </a>
                    ...
                    <form class="inline-block" method="POST" action="' . route('dashboard.product.destroy', $item->id) . '">
                        ...
                        <button class="bg-red-500 hover:bg-red-700 text-white font-bold mx-2 py-1.5 px-4 rounded shadow-lg" type="submit">
                            Delete
                        </button>
                    </form>
                    ';
